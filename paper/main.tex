...
already surrounded by a We study this with a transparent mechanistic agent-based model, every
modeling decision logged with the code (Sect.~\ref{sec:discussion}).
...
optima~\cite{ou2022}. Each condition: 50 replicates (sweeps: 12), fresh
